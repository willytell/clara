...
This pipeline2.py takes as input:
  1. the image files, and
  2. the shifted mask files (preprocessed by pipeline1.py).

Using 1. and 2., this code find the labels in the mask files and, as output, save them in the directory
contained in the outputPath variable.
"""
