"""
This 'pipeline1.py' applies for each mask file a shift of 2 pixels in the axis x and axis y. And save them
in a directory contained in the outputPath variable.
"""
